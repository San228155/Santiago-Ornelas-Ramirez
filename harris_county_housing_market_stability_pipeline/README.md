...
Harris County has determined they need 500 thousand houses for this population<sup><a href="#note1">1</a></sup>. The County has determined that an affordable house is 4 times the yearly salary of a household. 

We provide an pipeline from Harris County's Property data <sup><a href="#note2">2</a></sup>

To answer the problem, we devide it into 3 sub questions.
...
<a href="#note2"></a>2 https://hcad.org/pdata/pdata-property-downloads.html
